...
class Environment extends EnvironmentConfig {
  BUILD_TIMESTAMP = 1732036768;
  BUILD_VERSION = "107357e";
  I18N = loadI18n();
  PLUGINS_ENV = {};
...
class ParseError extends Error {
  constructor(message, options2) {
    super(message), __publicField(this, "type"), __publicField(this, "field"), __publicField(this, "value"), __publicField(this, "line"), this.name = "ParseError", this.type = options2.type, this.field = options2.field, this.value = options2.value, this.line = options2.line;
  }
}
function noop(_arg) {
}
...
`) ? data.slice(0, -1) : data
  ...
  function reset(options2 = {}) {
    incompleteLine && options2.consume && parseLine(incompleteLine), id = void 0, data = "", eventType = "", incompleteLine = "";
  }
  return { feed, reset };
}
...
function createAnthropic(options2 = {}) {
  var _a15;
  const baseURL = (_a15 = withoutTrailingSlash(options2.baseURL)) != null ? _a15 : "https://api.anthropic.com/v1";
  const getHeaders = () => ({
...
function createGoogleGenerativeAI(options2 = {}) {
  var _a15;
  const baseURL = (_a15 = withoutTrailingSlash(options2.baseURL)) != null ? _a15 : "https://generativelanguage.googleapis.com/v1beta";
  const getHeaders = () => ({
...
function createOpenAI(options2 = {}) {
  var _a15, _b2, _c2;
  const baseURL = (_a15 = withoutTrailingSlash(options2.baseURL)) != null ? _a15 : "https://api.openai.com/v1";
  const compatibility = (_b2 = options2.compatibility) != null ? _b2 : "compatible";
  const providerName = (_c2 = options2.name) != null ? _c2 : "openai";
  const getHeaders = () => ({
    Authorization: `Bearer ${loadApiKey({
      apiKey: options2.apiKey,
  ...
  const toolResults = await Promise.all(
    toolCalls.map(async (toolCall) => {
      ...
      const result2 = await recordSpan({
        ...
        tracer,
        fn: async (span) => {
          const result22 = await tool2.execute(toolCall.args, {
            messages,
            abortSignal
          });
          try {
...
function AIMiddleware({ config, tools: tools2, activeTools, onStream, toolChoice, messageReferencer, chatModel }) {
  ...
  return {
    wrapGenerate: async ({ doGenerate, params, model }) => {
      ...
      await warpModel(model, config, activeTools, params.mode.toolChoice, chatModel);
...
async function warpModel(model, config, activeTools, toolChoice, chatModel) {
...
class Dalle extends (_a10 = OpenAIBase, _request_dec = [Log], _a10) {
  constructor() {
    super(...arguments);
    __publicField2(this, "modelKey", "DALL_E_MODEL");
    __publicField2(this, "enable", (context) => {
      return context.OPENAI_API_KEY.length > 0;
    });
    __publicField2(this, "model", (ctx) => {
      return ctx.DALL_E_MODEL;
    });
    __publicField2(this, "request", __runInitializers(_init, 8, this, async (prompt, context, extraParams) => {
    ...
    __publicField2(this, "render", async (response) => {
...
class Transcription extends (_b = OpenAIBase, _request_dec2 = [Log], _b) {
  constructor() {
    super(...arguments);
    __publicField2(this, "modelKey", "OPENAI_STT_MODEL");
    __publicField2(this, "enable", (context) => {
      return context.OPENAI_API_KEY.length > 0;
    });
    __publicField2(this, "model", (ctx) => {
    ...
    __publicField2(this, "request", __runInitializers(_init2, 8, this, async (audio, context) => {
...
class ChatHandler {
  ...
  async processOriginalMessage(message, context) {
    const { type: type2, id } = context.MIDDEL_CONTEXT.originalMessageInfo;
    const params = {
      role: "user",
...
async function workflow(context, message, params) {
  ...
  return handler2(message, params, context);
}
async function handleTextToText(message, params, context) {
  return chatWithLLM(message, params, context, null);
}
async function handleTextToImage(message, params, context) {
  ...
  const result2 = await agent.request(message.text || message.caption || "", context.USER_CONFIG);
...
async function handleAudioToText(message, params, context) {
...
function createAzure(options2 = {}) {
  ...
  const url = ({ path, modelId }) => options2.baseURL ? `${options2.baseURL}/${modelId}${path}?api-version=2024-10-01-preview` : `https://${getResourceName()}.openai.azure.com/openai/deployments/${modelId}${path}?api-version=2024-10-01-preview`;
...
function createMistral(options2 = {}) {
  var _a15;
  const baseURL = (_a15 = withoutTrailingSlash(options2.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => ({
    Authorization: `Bearer ${loadApiKey({
      apiKey: options2.apiKey,
...
class WorkersImage extends (_c = WorkerBase, _request_dec3 = [Log], _c) {
  constructor() {
    super(...arguments);
    __publicField2(this, "modelKey", "WORKERS_IMAGE_MODEL");
    __publicField2(this, "model", (ctx) => {
      return ctx.WORKERS_IMAGE_MODEL;
    });
    __publicField2(this, "request", __runInitializers(_init3, 8, this, async (prompt, context) => {
      const id = context.CLOUDFLARE_ACCOUNT_ID;
      const token = context.CLOUDFLARE_TOKEN;
      if (!id || !token) {
  ...
  defaultInlineKeys = (context) => {
    ...
    return {
      ...
      INLINE_FUNCTION_TOOLS: {
        ...
        available_values: [.../* @__PURE__ */ new Set([...Object.keys(tools), ...Object.keys(ENV.PLUGINS_FUNCTION)])]
      }
    };
  };
...
class HandleMediaGroupMessage extends Lock {
  handle = async (message, context) => {
    ...
    if (message.media_group_id && ["photo", "image"].includes(msgInfo.type) && Array.isArray(msgInfo.id)) {
      ...
      if (fileIds) {
        context.MIDDEL_CONTEXT.originalMessageInfo.id = fileIds;
      }
    }
    return null;
  };
...
class UpstashRedis {
  ...
  async fetchFromRedis(method = "GET", body = null) {
    ...
    const response = await fetch(this.baseUrl, options2);
    if (!response.ok) {

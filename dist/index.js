...
class Environment extends EnvironmentConfig {
  BUILD_TIMESTAMP = 1731690489;
  BUILD_VERSION = "5aca20a";
  I18N = loadI18n();
  PLUGINS_ENV = {};
...
function getLog(context, returnModel = false, isTelegraph) {
...
function AIMiddleware({ config, models, tools: tools2, activeTools, onStream, toolChoice, messageReferencer }) {
  ...
  return {
    ...
    transformParams: async ({ type: type2, params }) => {
      ...
      warpMessages(params, tools2, activeTools);
      return params;
    },
    onChunk: (data) => {
      const { chunk } = data;
...
function warpMessages(params, tools2, activeTools) {
...
async function sendTelegraph(context, sender, question, text, raw) {
